...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.userDo.UseModel(&biz.User{})

	tableName := _user.userDo.TableName()
	_user.ALL = field.NewAsterisk(tableName)
	_user.UID = field.NewUint8(tableName, "uid")
...
func (u *user) updateTableName(table string) *user {
	...
	u.UID = field.NewUint8(table, "uid")
...
func (u userDo) Create(values ...*biz.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) CreateInBatches(values []*biz.User, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userDo) Save(values ...*biz.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) First() (*biz.User, error) {
...
func (u userDo) Take() (*biz.User, error) {
...
func (u userDo) Last() (*biz.User, error) {
...
func (u userDo) Find() ([]*biz.User, error) {
	result, err := u.DO.Find()
	return result.([]*biz.User), err
}

func (u userDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*biz.User, err error) {
	buf := make([]*biz.User, 0, batchSize)
...
func (u userDo) FindInBatches(result *[]*biz.User, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userDo) FirstOrInit() (*biz.User, error) {
...
func (u userDo) FirstOrCreate() (*biz.User, error) {
...
func (u userDo) FindByPage(offset int, limit int) (result []*biz.User, count int64, err error) {
...
func (u userDo) Delete(models ...*biz.User) (result gen.ResultInfo, err error) {
