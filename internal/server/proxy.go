...
import (
	...
	"github.com/pangud/pangud/internal/endpoint/biz"
)

// ReverseService ftp用户业务接口
type ReverseService struct {
	log       *zap.Logger
	agentRepo biz.AgentReadRepository
}

// NewReverseProxy new reverseProxy proxy
func NewReverseProxy(agentRepo biz.AgentReadRepository, log *zap.Logger) *ReverseService {
